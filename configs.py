...
class Configs:
    ...
    CHANNEL_LINK = getenv("CHANNEL_LINK", "https://t.me/FARZBotsAz")
    GROUP_LINK = getenv("GROUP_LINK", "https://t.me/FARZSupport")
    UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://t.me/FarzMusicAsistan")
